(require "stdlib.ss")
(require "stage2-expander.ss")

;; set to true for better output
(define *debug* #f)
...
(define (make-function *name* *formal-args* *outer*)
  ...
  (define *upvals* '()) ;; (name, copy-from-outer-index, upval-index)
...
;; XXX hack
(define read-program read)

(define (run-program program)
  (define expanded (expand-builtin-macro program))
  (define compiled-code (compile-program expanded))
